...
class ColorConstant {
  static Color MainColor = const Color.fromARGB(255, 4, 51, 44);
  static Color Beige = const Color.fromARGB(255, 185, 165, 122);
  static Color LightPetroleum = const Color.fromARGB(255, 36, 78, 84);
  ...
  static Color Black = const Color.fromARGB(255, 30, 30, 30);
}
