...
return conflict(_that.message);case InternalServerError() when internalServerError != null:
...
return conflict(_that.message);case InternalServerError():
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Conflict&&(identical(other.message, message) || other.message == message));
}
